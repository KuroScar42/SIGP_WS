...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByNombreUsuarioContrasenia", query = "SELECT u FROM Usuarios u WHERE u.nombreUsuario = :nombreUsuario and u.contrasennaUsuario = :contrasennaUsuario"),
